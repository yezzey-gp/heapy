 ...
 */
void HeapyATExecSetTableSpace(Relation aorel, Oid reloid,
...
//   RelationDropStoragePure(aorel);
  ...
  /* Heapy: do we need to move indexes? */
  // /*
...
void HeapyDefineOffloadPolicy(Oid reloid) {
  ...
  (void)HeapyATExecSetTableSpace(aorel, reloid, HEAPYTABLESPACE_OID);
